...
export class FullscreenManager {
    ...
    static isSpotifyFullscreenTrigger(clickTarget) {
        ...
        const isVisualizerControl = clickTarget.closest(
            "#spicetify-visualizer-settings-dropdown, .spicetify-visualizer-settings-dropdown, #spicetify-visualizer-toggle-btn, #spicetify-visualizer-settings-btn, #cyber-cat-fs-hint"
        );
