...
export class WebAudioStreamBridge {
    constructor(featureExtractor, phaseTracker, bandAnalyzer) {
        ...
        try {
            this.autoConnectSavedPreference = (typeof localStorage !== "undefined")
                ? localStorage.getItem("spicetify-visualizer-live-audio") === "true"
                : false;
    ...
    async startMicrophoneCapture() {
        try {
            ...
            if (isConnected) {
                ...
                try { if (typeof localStorage !== "undefined") localStorage.setItem("spicetify-visualizer-live-audio", "true"); } catch (err) {}
            }
            return isConnected;
        } catch (captureError) {
    ...
    stopMicrophoneCapture() {
        ...
        this.isLiveInputCapturing = false;
        try { if (typeof localStorage !== "undefined") localStorage.setItem("spicetify-visualizer-live-audio", "false"); } catch (err) {}
    }
