...
export class ForestBackgroundManager {
    constructor() {
        this.shockwaves = [];
        ...
        this.supernova = new CosmicSupernovaBurst();
    ...
    spawnShockwave(originX, originY, maximumRadius, colorRgba, triggerType = "kick") {
        if (this.shockwaves.length < 12) {
            this.shockwaves.push(new ShockwaveRingParticle(originX, originY, maximumRadius, colorRgba, triggerType));
        }
    }
