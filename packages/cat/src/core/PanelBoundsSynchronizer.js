export class PanelBoundsSynchronizer {
    ...
    static syncPanelBounds(visualizerEngine) {
        ...
        if (spotifyMainViewElement && !visualizerEngine.isFullscreen) {
            ...
            visualizerEngine.catCenterX = mainViewBounds.left + mainViewBounds.width * 0.50;
            visualizerEngine.catCenterY = mainViewBounds.top + mainViewBounds.height * 0.52;
        } else {
            visualizerEngine.catCenterX = visualizerEngine.width * 0.50;
            visualizerEngine.catCenterY = visualizerEngine.height * 0.52;
        }
    }
